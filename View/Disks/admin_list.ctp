...
$this->Backend->addColumn('id', array(
	'width' => 55,
	'type' => 'number',
	'label' => __d('admin_disks', 'column_id')
));
$this->Backend->addColumn('brand_id', array(
	'label' => __d('admin_disks', 'column_brand_id'),
	'type' => 'list',
	'sortable' => false,
	'options' => $brands
));
$this->Backend->addColumn('model_id', array(
	'label' => __d('admin_disks', 'column_model_id'),
	'type' => 'list',
	'sortable' => false,
	'options' => $models,
...
$this->Backend->addColumn('supplier_id', array(
	'label' => __d('admin_disks', 'column_supplier_id'),
	'type' => 'list',
	'sortable' => false,
	'options' => $suppliers
));
$this->Backend->addColumn('sku', array(
	'label' => __d('admin_disks', 'column_sku'),
	'editable' => true
));
$this->Backend->addColumn('size', array(
	'label' => __d('admin_disks', 'column_size'),
	'renderer' => 'disk_size',
	'filterable' => false,
	'sortable' => false
));
$this->Backend->addColumn('price', array(
	'label' => __d('admin_disks', 'column_price'),
	'renderer' => 'product_price',
	'filterable' => false
));
$this->Backend->addColumn('stock_count', array(
	'label' => __d('admin_disks', 'column_stock_count'),
...
$this->Backend->addColumn('in_stock', array(
	...
	'title_enabled' => __d('admin_disks', 'title_stockon'),
	'title_disabled' => __d('admin_disks', 'title_stockoff'),
	'prefix' => 'stock'
));
$this->Backend->addColumn('is_active', array(
	...
	'title_enabled' => __d('admin_disks', 'title_enabled'),
	'title_disabled' => __d('admin_disks', 'title_disabled'),
	'prefix' => 'status'
));
