...
?>
<?php if ($show_filter == 10) { $path = 'main';?>
<div class="filter-group tyres" id="filter">
	...
	<div class="item">
		...
		<div class="item-inner">
			<label class="name" for="ProductAuto">Тип:</label>
			<div class="inp"><?php
	...
	<div class="item item2">
		<div class="item-inner">
			...
			<div class="inp"><?php
				echo $this->Form->input('size1', array('type' => 'select', 'label' => false, 'options' => $tyre_size1, 'empty' => array('' => 'Все'), 'div' => false, 'class' => 'sel-style2 filter-select'));
				echo $this->Form->input('size2', array('type' => 'select', 'label' => false, 'options' => $tyre_size2, 'empty' => array('' => 'Все'), 'div' => false, 'class' => 'sel-style2 filter-select'));
				echo $this->Form->input('size3', array('type' => 'select', 'label' => false, 'options' => $tyre_size3, 'empty' => array('' => 'Все'), 'div' => false, 'class' => 'sel-style2 filter-select'));
			?></div>
			<div class="clear"></div>
		</div>
		<div class="item-inner col-r">
...
<?php } elseif ($show_filter == 10) { $path = 'disks';?>
...
<?php } elseif ($show_filter == 10) { $path = 'bolts';?>
...
<?php } elseif ($show_filter == 10) { $path = 'akb';?>
<div class="filter-group" id="filter">
	<?php
	...
	<div class="item item5">
		<div class="item-inner">
			<label class="name" for="ProductBrandId">Производитель:</label>
			<div class="inp"><?php
				echo $this->Form->input('brand_id', array('class' => 'filter-select sel-style4', 'type' => 'select', 'label' => false, 'options' => $filter_brands, 'empty' => array('' => 'Все'), 'div' => false, 'required' => false));
			?></div>
			<div class="clear"></div>
		</div>
		<div class="item-inner">
			...
			<div class="inp"><?php
				echo $this->Form->input('ah', array('class' => 'filter-select sel-style4', 'type' => 'select', 'label' => false, 'options' => $akb_ah, 'empty' => array('' => 'Все'), 'div' => false));
			?></div>
			<div class="clear"></div>
		</div>
		<div class="item-inner">
			...
			<div class="inp"><?php
				echo $this->Form->input('current', array('class' => 'filter-select sel-style4', 'type' => 'select', 'label' => false, 'options' => $akb_current, 'empty' => array('' => 'Все'), 'div' => false));
			?></div>
			<div class="clear"></div>
		</div>
	</div>
	<div class="item item2">
		<div class="item-inner">
			...
			<div class="inp"><?php
				echo $this->Form->input('width', array('class' => 'filter-select sel-style4', 'type' => 'select', 'label' => false, 'options' => $akb_width, 'empty' => array('' => 'Все'), 'div' => false));
			?></div>
			<div class="clear"></div>
		</div>
		<div class="item-inner" for="ProductLength">
			...
			<div class="inp"><?php
				echo $this->Form->input('length', array('class' => 'filter-select sel-style4', 'type' => 'select', 'label' => false, 'options' => $akb_length, 'empty' => array('' => 'Все'), 'div' => false));
			?></div>
			<div class="clear"></div>
		</div>
		<div class="item-inner">
			...
			<div class="inp"><?php
				echo $this->Form->input('height', array('class' => 'filter-select sel-style4', 'type' => 'select', 'label' => false, 'options' => $akb_height, 'empty' => array('' => 'Все'), 'div' => false));
			?></div>
			<div class="clear"></div>
		</div>
	</div>
...
<div class="filter-group" id="filter">
	...
	<div class="item item5">
		<div class="item-inner">
			...
			<div class="inp"><?php
				echo $this->Form->input('brand_id', array('type' => 'select', 'label' => false, 'options' => $car_brands, 'empty' => array('' => '...'), 'div' => false, 'class' => 'sel-style4', 'required' => false));
			?></div>
			<div class="clear"></div>
		</div>
		<div class="item-inner">
			...
			<div class="inp"><?php
				echo $this->Form->input('model_id', array('type' => 'select', 'label' => false, 'options' => $car_models, 'empty' => array('' => '...'), 'div' => false, 'class' => 'sel-style4'));
			?></div>
			<div class="clear"></div>
		</div>
	</div>
	<div class="item item6">
		<div class="item-inner">
			...
			<div class="inp"><?php
				echo $this->Form->input('year', array('class' => 'sel-style4', 'type' => 'select', 'label' => false, 'options' => $car_years, 'empty' => array('' => '...'), 'div' => false, 'name' => 'year'));
			?></div>
			<div class="clear"></div>
		</div>
		<div class="item-inner" for="CarMod">
			...
			<div class="inp"><?php
				echo $this->Form->input('mod', array('class' => 'sel-style4', 'type' => 'select', 'label' => false, 'options' => $car_modifications, 'empty' => array('' => '...'), 'div' => false));
			?></div>
			<div class="clear"></div>
		</div>
	</div>
