...
//	echo"------";
	...
	//print_r($result);
	//$result->result['data'][0][2]='http://kerchshina.com/files/mag/img4.png';
	///mag/img4.png 
	
	//print_r(array($input['method'], $input['params'][0]));
	...
	die($data);
//	die('{"result":{"header":null,"columns":["name","path","url","size","type","created","modified","attribs","custom"],"data":[["img3.png","{0}/mag/img3.png","http://kerchshina.commg3.png",363967,"png",1444924324,1348217161,"RW",{"editable":true,"thumbnail":true,"twidth":90,"theight":47,"thumbnail_url":"http://kerchshina.comcith/mcith_img3.png","width":580,"height":305}]]},"id":"c0","error":null}');
} 
